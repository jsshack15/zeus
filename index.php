...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <meta name="description" content="Conservo | Efficient India ">
        
        <meta name="author" content="Zeus">
		
        <title>Conservo | Efficient India</title>
				...
				<div class="sl-slider">
					...
					<div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
						...
						<div class="carousel-caption">
							<div>
							<!--	<img class="wow fadeInUp" src="img/Conservo.png" alt="Conservo"> -->
								<h2 data-wow-duration="500ms"  data-wow-delay="500ms" class="heading animated fadeInRight">Conservo</h2>
							</div>
						</div>
						</div>
					</div>
					...
					<div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="3" data-slice2-rotation="3" data-slice1-scale="2" data-slice2-scale="1">
						...
						<div class="carousel-caption">
							<div>
								<h2 class="heading animated fadeInRight">Conservo Schemes</h2>
	...
	<!--	<section id="main-features">
		...
		<!--			<div id="features">
					...
					<!--			<div class="col-md-6 feature-desc wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
									<h3>Main Features of Conservo</h3>
	...
	<!--		<div class="portfolio-item-wrapper wow fadeInUp" data-wow-duration="500ms">
		...
		<!--			<li class="mix app">
						<a href="javascript:void(0)" data-largesrc="img/portfolio/portx1.jpg" data-title="Azuki bean" data-description="Swiss chard pumpkin bunya nuts maize plantain aubergine napa cabbage soko coriander sweet pepper water spinach winter purslane shallot tigernut lentil beetroot.">
							<img src="img/portfolio/portx1.jpg" alt="Conservo">
	...
	<!--	</section>   <!-- End section -->
				...
				<div class="row">
					...
					<div class="col-md-3 col-md-offset-2 col-sm-6 wow fadeInDown" data-wow-duration="500ms">
                       <article class="team-mate">
							<div class="member-photo">
								<!-- member photo -->
								<img class="img-responsive" src="img/team/mukul.jpg" alt="Conservo">
								<!-- /member photo -->
					...
					<div class="col-md-3 col-sm-6 wow fadeInDown" data-wow-duration="500ms" data-wow-delay="200ms">
                       <article class="team-mate">
							<div class="member-photo">
								<!-- member photo -->
								<img class="img-responsive" src="img/team/amal.jpg" alt="Conservo">
								<!-- /member photo -->
					...
					<div class="col-md-3 col-sm-6 wow fadeInDown" data-wow-duration="500ms" data-wow-delay="400ms">
                       <article class="team-mate">
							<div class="member-photo">
								<!-- member photo -->
								<img class="img-responsive" src="img/team/shrey.jpg" alt="Conservo">
								<!-- /member photo -->
		...
		<!--			<div class="col-md-3 col-sm-6 wow fadeInDown" data-wow-duration="500ms" data-wow-delay="600ms">
                       <article class="team-mate kill-margin-bottom">
							<div class="member-photo">
								<!-- member photo -->
		<!--						<img class="img-responsive" src="img/team/member-1.jpg" alt="Conservo">
								<!-- /member photo -->
			...
			<div class="container">
				<div class="row">
					...
					<div class="all-post text-center">
						<a class="btn btn-transparent" href="blog.php">View All Post</a>
					</div>
			    ...
			    <div class="row wow fadeInUp" data-wow-duration="500ms">
					<div class="col-lg-12">
						...
						<!--		<img src="img/logo-Conservo.png" alt="Conservo" /> -->
							...
							<p>Design And Developed by <strong><font color ="green">Zeus Team</font></strong></a>. Copyright &copy; 2015. All Rights Reserved.</p>
						</div>
						<!-- /copyright -->
